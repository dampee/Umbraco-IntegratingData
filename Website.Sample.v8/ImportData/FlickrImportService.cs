...
{
    public class FlickerImportComposer : IUserComposer
    {
        public void Compose(Composition composition)
        {
            composition.Register<FlickrImportService>();
        }
    }
    ...
    public class FlickrImportService : IImportService
    {
        ...
        public bool AddDummyContent(StringBuilder sb)
        {
            ...
            // KUdos for Tarik : https://our.umbraco.com/forum/umbraco-8/96589-upload-a-new-media-item-from-code-in-v8
            var contentTypeBaseServiceProvider = Current.Services.ContentTypeBaseServices;
            newmedia.SetValue(contentTypeBaseServiceProvider, "umbracoFile", Path.GetFileName(newFileName), s); // First issue
            s.Close();
